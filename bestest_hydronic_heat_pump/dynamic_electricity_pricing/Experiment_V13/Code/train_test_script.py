...
"""
import os
os.chdir(r'C:/Users/gauthambekal93/Research/model_based_rl/bestest_hydronic_heat_pump/dynamic_electricity_pricing/Experiment_V13/Code')
...
from simulation_environments import bestest_hydronic, max_episode_length, step_period, start_time_tests,episode_length_test, warmup_period_test
...
'''        
requests.put('{0}/initialize'.format('http://127.0.0.1:5000'), 
                   json={'start_time':int( (348-7)*24*3600 ) ,
                         'warmup_period':int(24*3600)}).json()['payload']
'''

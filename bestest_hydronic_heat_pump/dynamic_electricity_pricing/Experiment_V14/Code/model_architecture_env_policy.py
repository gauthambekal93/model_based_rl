...
class Environment_Module(nn.Module):
    ...
    def __init__(self, input_dims, n_actions=2, alpha=1, beta=0.2):
        ...
        self.input_layer_next_state = nn.Linear( input_dims + 1 , 100)
    
        self.hidden1_next_state =  nn.Linear( 100, 100 )
        
        self.hidden2_next_state =  nn.Linear( 100, 100 )
        
        self.hidden3_next_state =  nn.Linear( 100, 100 )
        
        self.next_state =  nn.Linear( 100, input_dims )
        
        
        #reward prediction
        self.input_layer_reward = nn.Linear( input_dims + 1 , 100)
        
        self.hidden1_reward =  nn.Linear( 100, 100 )
        
        self.hidden2_reward =  nn.Linear( 100, 100 )
        
        self.hidden3_reward =  nn.Linear( 100, 100 )
        
        self.reward = nn.Linear( 100, n_actions -1 )
...
class Policy_Module_Pretrained_Boptest(nn.Module):
